...
## Основные объекты
* Моном:
  * Хранит коэффициент и свёрнутую степень.
...
Создаем звено и заполняем его данными полинома.
Добавляем созданное звено в начало списка.
Удаление элемента из таблицы.
По переданному ключу ищем полином, который нужно удалить.
Удаляем полином из списка, используя обычный алгоритм удаления работы со списками.
Поиск элемента.
Ищем по ключу нужный полином. 
